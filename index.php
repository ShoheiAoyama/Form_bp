        ...
        <div class="container">
            <div class="row">
                <div class="col-md-6 mx-auto">
                    <h2>Please fill out the form<small>Please fill out the form below and press the submit
                            button.</small></h2>
                </div>
            </div>
        </div>
                    ...
                    <div class="col-md-6 mx-auto">
                        <form id="form" class="checkform" name="checkform" method="post" action="index.php">
                            <div class="form-group">
                                ...
                                <!--名-->
                                <input class="form-control chars16 namekind" placeholder="名" id="name_mei" type="text"
                                       name="name_mei"
                                ...
                                <div class="form-row">
                                    <div class="col">
                                        <select class="form-control year" id="year" name="year"
                                                onchange="birth(this.form);dateValidation(this, 'year', 'month', 'day')"
                                                value="<?php if (!empty($_POST['year'])) {
                                                    echo h($_POST['year']);
                                                } ?>" required>
                                    ...
                                    <div class="col">
                                        <select class="form-control day" id="day"
                                                onchange="birth(this.form);dateValidation(this, 'year', 'month', 'day')"
                                                name="day" required>
                            ...
                            <input type="hidden" name="birthday" id="birthday"
                                   value="<?php echo h($_POST['birthday']); ?>">
                            </br>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control number number0" placeholder="固定電話または携帯電話" type="text"
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control alpha chars225" placeholder="example@example.com" type="text"
                                       name="email" id="email"
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control chars225" placeholder="市町村 番地 建物名" type="text" name="address"
                                       id="address"
                            ...
                            <div class="form-group">
                                ...
                                <textarea class="form-control chars1000" id="msg" name="msg" rows="3" style="text-align: left" required><?php if (!empty($_POST['msg'])) { echo h($_POST['msg']);} ?></textarea>
                                <span class="alertarea"></span>
                            </div>
                            </br>
                            <button id="button1" type="submit" class="btn btn-outline-light mb-5" name="btn_confirm"
                                    value="確認画面へ">確認画面へ
                            </button>

                                <!--Enterキー無効バリデーション-->
                                <!--<button id="button1" type="button" class="btn btn-outline-light mb-5" name="btn_confirm"-->
                                <!--value="確認画面へ" onclick="getValue();enter()">確認画面へ-->
                                <!--</button>-->
...
　　　　　<!-- 運転免許証をチェックしなかった場合、$_POST['license'] = '0'とする-->
            <?php
